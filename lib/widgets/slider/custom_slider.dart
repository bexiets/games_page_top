...
class SliderPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRect(
      Rect.fromLTWH(0, (size.height - sliderHeight) / 2, size.width, sliderHeight),
      inactivePaint,
    );


    double activeWidth = ((currentValue - min) / (max - min)).clamp(0.0, 1.0) * size.width;


    canvas.drawRect(
      Rect.fromLTWH(0, (size.height - sliderHeight) / 2, activeWidth, sliderHeight),
      activePaint,
    );
